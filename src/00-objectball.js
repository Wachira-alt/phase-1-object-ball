...
function numPointsScored(playerName) {
  ...
  // Function to return jersey numbers of a team
...
function mostPointsScored() {
  ...
  // Function to find the team with the most total points
